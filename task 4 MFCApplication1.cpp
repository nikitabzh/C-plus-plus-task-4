...
// task 4 MFCApplication1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Ctask4MFCApplication1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Ctask4MFCApplication1App

Ctask4MFCApplication1App::Ctask4MFCApplication1App()
{
...
// Единственный объект Ctask4MFCApplication1App

Ctask4MFCApplication1App theApp;


// Инициализация Ctask4MFCApplication1App

BOOL Ctask4MFCApplication1App::InitInstance()
{
